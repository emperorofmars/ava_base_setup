...
namespace com.squirrelbite.ava_base_setup.vrchat.VRLabs.AV3Manager
{
	...
	public static class AV3ManagerFunctions
	{
		...
		/// <param name="directory">The unique directory to store the new parameter asset, ex. "Assets/MyCoolScript/GeneratedAssets/725638/".</param>
		/// <param name="overwrite">Optionally, choose to not overwrite an asset of the same name in directory. See class for more info.</param>
		public static void AddParameters(VRCAvatarDescriptor descriptor, IEnumerable<VRCExpressionParameters.Parameter> parameters, string directory, bool overwrite = true, bool skipSave = false)
		{
			if (descriptor == null)
			{
			...
			if (((directory == null) || (directory == "")) && !skipSave)
			{
			...
			if (descriptor.expressionParameters == null && !skipSave)
			{
			...
			else
			{
				...
				{
					newParameters = descriptor.expressionParameters;
				}
			}
		...
		/// <param name="overwrite">Optionally, choose to not overwrite an asset of the same name in directory. See class for more info.</param>
		public static void AddSubMenu(VRCAvatarDescriptor descriptor, VRCExpressionsMenu menuToAdd, string controlName, string directory, VRCExpressionsMenu.Control.Parameter controlParameter = null, Texture2D icon = null, bool overwrite = true, bool skipSave = false)
		{
			if (descriptor == null)
			{
			...
			else if (((directory == null) || (directory == "")) && !skipSave)
			{
			...
			if (descriptor.expressionsMenu == null && !skipSave)
			{
