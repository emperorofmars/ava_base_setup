...
{
	public static class SetupFTLayerWeightControlVRC
	{
		public static void Apply(SetupStateVRC State, AnimatorController Controller, VRCAvatarDescriptor.AnimLayerType Layer)
		{
		...
		private static void SetupBehaviour(SetupStateVRC State, AnimatorState AnimState, VRC_AnimatorLayerControl.BlendableLayer Layer, int LayerStart, int LayerCount, float GoalWeight)
		{
