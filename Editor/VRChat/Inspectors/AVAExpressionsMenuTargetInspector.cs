...
namespace com.squirrelbite.ava_base_setup.vrchat
{
	...
	public class AVAExpressionsMenuTargetDrawer : PropertyDrawer
	{
		...
		{
			return new UnityPlzAVAExpressionsMenuTarget(property);
		}
	}

	sealed class UnityPlzAVAExpressionsMenuTarget : VisualElement
	{
		private readonly SerializedProperty _property;

		public UnityPlzAVAExpressionsMenuTarget(SerializedProperty property)
		{
			_property = property;
			var ui = this;
			ui.style.flexDirection = FlexDirection.Row;
			ui.style.alignItems = Align.Stretch;
			var e = Toolkit.AddElement(ui, new PropertyField(property.FindPropertyRelative("Target"), ""));
			e.style.minWidth = 120;
			e.style.flexGrow = 1;
			var a = Toolkit.AddElement(ui, new PropertyField(property.FindPropertyRelative("Menu"), ""));
